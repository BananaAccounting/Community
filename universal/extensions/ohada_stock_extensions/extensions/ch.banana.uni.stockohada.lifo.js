...
// @description.it = 2. Scheda magazzino OHADA - LIFO
// @task = app.command
// @doctype = *

var STOCK_METHOD = "LIFO";
        ...
        */
        ...
        if (qtyIn > 0) {
            ...
            */
            ...
            for (var j = 0; j < lifoLayers.length; j++) {

                var layer = lifoLayers[j];
